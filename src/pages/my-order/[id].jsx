  ...
  return (
    <>
      ...
      <div className='flex w-full items-center relative justify-center mb-4'>
        ...
        {
          currentOrder && currentOrder.length > 0 && currentOrder[0].products.map((product)=> (
            <OrderCard
              key={product.id} 
              title={product.title}
              image={product.image}
        ...
        <div className='flex justify-between items-center mt-6'>
          ...
          <span className='font-medium text-xl'>{currentOrder && currentOrder.length > 0 && currentOrder[0].totalPrice}</span>
        </div>
      </div>
  </>
  )
